...
function tmp_create_bullet(_dir, _spd, _fac, _gun_type = -1)
{
	...
	switch _gun_type
	{
		case powerups.three_bullets:
			...
			initialize_bullet(_dir, _spd, _fac, stt_b.inst());
		...
		case powerups.two_bullets:
			i = 0; repeat(2)
			{
				stt_b.d = (i == 0) ? stt_b.d + 90 : stt_b.d - 90;
				initialize_bullet(_dir, _spd, _fac, stt_b.inst());
				stt_b.d = _dir;
				i += 1;
			}
		...
		case powerups.star_bullets:
			...
			i = 0; repeat(n)
			{
				stt_b.d = (stt_b.g == 3) ? stt_b.d  + (i * 90) : stt_b.d  + (i * 45);
				initialize_bullet(stt_b.d, _spd, _fac, stt_b.inst());
				stt_b.d = _dir;
				i += 1;
			}
